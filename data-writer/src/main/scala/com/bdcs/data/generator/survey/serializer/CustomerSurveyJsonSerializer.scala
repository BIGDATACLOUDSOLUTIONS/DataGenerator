package com.bdcs.data.generator.survey.serializer
...
class CustomerSurveyJsonSerializer extends Serializer[CustomersSurveyJson] {
   ...
   * @return byte[]
   */
  override def serialize(topic: String, data: CustomersSurveyJson): Array[Byte] = {
    if (data == null) {
